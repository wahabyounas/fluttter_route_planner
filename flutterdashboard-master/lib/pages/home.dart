...
class _MyHomeState extends State<MyHome> {
  int currentTab = 0;
  final List<Widget> screens = [Chat(), Profile(), MyMap()];
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          Icons.dashboard,
                          color:
                              currentTab == 0 ? Color(0xFF3276b1) : Colors.grey,
                        ),
                        Text(
                          'Dashboard',
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          Icons.chat,
                          color:
                              currentTab == 1 ? Color(0xFF3276b1) : Colors.grey,
                        ),
                        Text(
                          'Chat',
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          Icons.map,
                          color:
                              currentTab == 2 ? Color(0xFF3276b1) : Colors.grey,
                        ),
                        Text(
                          'Map',
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        Icon(
                          Icons.account_box,
                          color:
                              currentTab == 3 ? Color(0xFF3276b1) : Colors.grey,
                        ),
                        Text(
                          'Profile',
                          style: TextStyle(
